...
- [lang3-oop] `Inferable` absurd
- [lang3-oop] `Inferable` begin
- [lang3-oop] `Inferable` cls
- [lang3-oop] `Inferable` equal
- [lang3-oop] `Inferable` pi
- [lang3-oop] `Inferable` str
- [lang3-oop] `Inferable` the
- [lang3-oop] `Inferable` type
- [lang3-oop] `Inferable` typecons
- [lang3-oop] `Inferable` union
- [lang3-oop] `Inferable` var
...
- [lang3-oop] `Exp` as an intersection of `Repr & Checkable`
  - `Checkable` can override the `checkability` generated by `Inferable`

- [lang3-oop] `Value` `Neutral` `Normal`
