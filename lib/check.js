...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./exp", "./value", "./scope", "./report", "./evaluate", "./infer", "./subtype", "./equivalent", "./pretty", "./util"], factory);
    }
        ...
        if (t instanceof Value.Cl) {
            ...
            for (let [name, entry] of cl.scope.named_entries) {
                ...
                if (entry instanceof Scope.Entry.Let) {
                    ...
                    throw new Error("check_obj fail\n" +
    ...
    function check_fn(env, scope, body, t) {
        if (t instanceof Value.Pi) {
            ...
            for (let i = 0; i < scope.arity; i++) {
                ...
                let unique_var = util.unique_var_from(`check:Fn:${pi_arg_name}:${fn_arg_name}`);
