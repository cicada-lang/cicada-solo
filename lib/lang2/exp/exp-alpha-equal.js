...
exports.alpha_equal = void 0;
function alpha_equal(x, y) {
    return alpha({
        depth: 0,
        left_names: new Map(),
        left: x,
...
exports.alpha_equal = alpha_equal;
function alpha(the) {
    ...
    if (left.kind === "Exp.v" && right.kind === "Exp.v") {
        ...
        return (alpha({ ...the, left: left.arg_t, right: right.arg_t }) &&
            alpha({
                depth: depth + 1,
        ...
        return (alpha({ ...the, left: left.car_t, right: right.car_t }) &&
            alpha({
                depth: depth + 1,
                left_names: left_names.set(left.name, depth),
                left: left.cdr_t,
        ...
        return (alpha({ ...the, left: left.car, right: right.car }) &&
        ...
        return (alpha({ ...the, left: left.t, right: right.t }) &&
    ...
    else if (left.kind === "Exp.absurd_ind" &&
