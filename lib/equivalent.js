...
function equivalent(s, t) {
    try {
        ...
        if (s instanceof Value.Type && t instanceof Value.Type) { }
            ...
            equivalent(s.t, t.t);
            equivalent(evaluate_1.evaluate(s.equation_env, s.lhs), evaluate_1.evaluate(t.equation_env, t.lhs));
            equivalent(evaluate_1.evaluate(s.equation_env, s.rhs), evaluate_1.evaluate(t.equation_env, t.rhs));
        }
