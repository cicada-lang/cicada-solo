...
const arg_entry = new rule_1.Rule("arg_entry", {
    "arg": [exp],
    "arg_comma": [exp, ","],
});
...
const top_entry = new rule_1.Rule("top_entry", {
...
exports.top_list = new rule_1.Rule("top_list", {
...
const scope = new rule_1.Rule("scope", {
...
const fn_case_clause = new rule_1.Rule("fn_case_clause", {
    "case": ["case", scope, "=", ">", exp],
});
