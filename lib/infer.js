...
(function (factory) {
    ...
    exports.infer = infer;
    function scope_check(env, scope) {
        var local_env = env;
    ...
    function infer_pi(env, scope, return_type) {
    ...
    exports.infer_pi = infer_pi;
    function infer_cl(env, scope) {
        // check(local_env, A1, type)
        // A1_value = evaluate(local_env, A1)
    ...
    exports.infer_cl = infer_cl;
    function infer_fn(env, scope, body) {
        // local_env = env
        // check(local_env, A1, type)
        // local_env = local_env.ext(x1, evaluate(local_env, A1), NeutralVar(x1))
        // ...
