    ...
    value match {
      ...
      case ValuePi(arg_type_map: ListMap[String, Exp], return_type: Exp, ctx: Ctx) =>
        ...
        val (arg_type_value_map, return_type_value) =
          util.force_telescope_with_return(name_list, arg_type_map, return_type, ctx)
      ...
      case ValueFn(arg_type_map: ListMap[String, Exp], body: Exp, ctx: Ctx) =>
        ...
        val (arg_type_value_map, body_value) =
          util.force_telescope_with_return(name_list, arg_type_map, body, ctx)
      ...
      case ValueTl(type_map: ListMap[String, Exp], ctx: Ctx) =>
        ...
        Cl(readback_list_map(util.force_telescope(name_list, type_map, ctx)))
