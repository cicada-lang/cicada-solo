...
export function is_pi(mod: Mod.Mod, ctx: Ctx.Ctx, value: Value.Value): Value.pi {
...
export function is_cls(mod: Mod.Mod,ctx: Ctx.Ctx, value: Value.Value): Value.cls {
...
export function is_equal(mod: Mod.Mod,ctx: Ctx.Ctx, value: Value.Value): Value.equal {
...
export function is_absurd(mod: Mod.Mod,ctx: Ctx.Ctx, value: Value.Value): Value.absurd {
...
export function is_str(mod: Mod.Mod,ctx: Ctx.Ctx, value: Value.Value): Value.str {
